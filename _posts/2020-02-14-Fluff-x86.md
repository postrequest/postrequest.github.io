...
We can see that the NX bit is set.
##### Identify sections:
![Sections](/assets/img/2020-02-14-Fluff-x86/sections.png)
The .data section at 0x0804a028 will be our target to write the string "/bin/sh" to.
##### Identify potential ROP gadgets that will be useful
